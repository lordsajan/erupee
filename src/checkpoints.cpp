...
namespace Checkpoints
{
    ...
    // erupee: synchronized checkpoint (centrally broadcasted)
    ...
    // erupee: get last synchronized checkpoint
    ...
    // erupee: only descendant of current sync-checkpoint is allowed
    ...
    // erupee: reset synchronized checkpoint to last hardened checkpoint
...
// erupee: sync-checkpoint master key
...
// erupee: verify signature of sync-checkpoint message
...
// erupee: process synchronized checkpoint
